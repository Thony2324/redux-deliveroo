      ...
      <div className="App">
          ...
          <div className="RestaurantInfos">
            <div className="RestaurantInfos--center">
              <div className="RestaurantInfos--texts">
                <h1>{this.props.deliveroo.data.restaurant.name}</h1>
                <p>{this.props.deliveroo.data.restaurant.description}</p>
              </div>
              <img
                className="RestaurantInfos--cover"
                src={this.props.deliveroo.data.restaurant.picture}
        ...
        <div className="Content">
          <div className="Content--center">
            <div className="Menu">
              {Object.keys(this.props.deliveroo.data.menu).map(categ => {
                if (this.props.deliveroo.data.menu[categ].length === 0) {
                  return null;
                }
                return (
                                    ...
                                    {item.popular ? (
                                      <span className="MenuItem--popular">
                                        <svg
                                          ...
                                          style={{ width: "20px", height: "20px", margiRight: "5px" }}>
